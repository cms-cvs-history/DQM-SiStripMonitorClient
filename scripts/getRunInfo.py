...
# file_cmsmonRunRegistry     = urllib.urlopen("http://cmsmon.cern.ch/runregistry/allrundata") # FIXME put back as soon as cmsmon is available again
file_cmsmonRunRegistry     = urllib.urlopen("http://pccmsdqm04.cern.ch/runregistry/allrundata")
...
# get run DBS entries
# str_dbsRuns      = urllib.urlencode({'ajax':'0', '_idx':'0', 'pagerStep':'0', 'userMode':'user', 'release':'Any', 'tier':'Any', 'dbsInst':'cms_dbs_prod_global', 'primType':'Any', 'primD':'Any', 'minRun':Str_run, 'maxRun':Str_run}) # FIXME which instance to use?
...
# # get run summary # FIXME put back as soon as cmsmon is available again
...
# # get magnetic field # FIXME put back as soon as cmsmon is available again
...
print  
# # from run summary # FIXME put back as soon as cmsmon is available again
